const localObject = localStorage.getItem('notes');

function setLocalObject(obj) {
...
class App {
  constructor() {
    this.notes = JSON.parse(localObject);
  ...
  addNote(note) {
    ...
    this.notes == null ? [newNote] : this.notes.push(newNote)[...this.notes, newNote];

    setLocalObject(this.notes);
